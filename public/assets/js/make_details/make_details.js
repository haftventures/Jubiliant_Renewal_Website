    ...
    <div class="card-container
      ...
      <div class="mt-auto">
        <div class="flex flex-col sm:flex-row gap-2">
          ...
          <!-- TRUE -->
          <button
            ${isTrue ? 'disabled' : `onclick="makeAction(${item.id}, '1')"`}
            class="flex-1 text-white py-2 rounded font-semibold
                   ${isTrue ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-700'}"
          ...
          <!-- FALSE -->
          <button
            ${isFalse ? 'disabled' : `onclick="makeAction(${item.id}, '2')"`}
            class="flex-1 text-white py-2 rounded font-semibold
                   ${isFalse ? 'opacity-50 cursor-not-allowed' : 'hover:bg-red-700'}"
          ...
          <!-- DOUBT -->
          <button
            ${isDoubt ? 'disabled' : `onclick="makeAction(${item.id}, '3')"`}
            class="flex-1 text-white py-2 rounded font-semibold
                   ${isDoubt ? 'opacity-50 cursor-not-allowed' : 'hover:bg-amber-600'}"
